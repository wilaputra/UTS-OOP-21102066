...
package atm;
 ...
 public class atm{
	...
	public static void main (String [] args)throws IOException {
		...
		int i=0;
		int pilihan, pilihan2, tabung, saldo = 999000000, ambil, isi, index=0, index2=0;
                int[] tambah_saldo=new int[20], tarik_saldo=new int[20];
		for(i=0; i<=2; i++){
			
			System.out.println("-------------------------------------------------");
			System.out.println("          Selamat Datang Di ATM INSTIKI          ");
                        System.out.println("-------------------------------------------------");
			...
			if( (user.equalsIgnoreCase("wila")) && (pin==1234) ){
			System.out.println("\n               Login Berhasil              ");
			System.out.println("\n");
			i=5;	
			...
			while(true){
				System.out.println("-------------------------------------------------");
				System.out.println("                   ATM INSTIKI                   ");
				System.out.println("-------------------------------------------------");
				System.out.println("\n1.Cek Saldo");
				...
				switch (pilihan) {
					...
					do{
                                            ...
                                            isi -= ambil;
                                            if (isi <= 100000) {
                                            System.out.println("Saldo Minimal setelah pengambilan harus Rp.100000");
                                            } else {
                                            saldo -= ambil;
                                            System.out.println("Saldo Anda adalah Rp. " + saldo);
                                            }
					...
					do{
                                            ...
                                            System.out.println("7. Saat penarikan, saldo minimal anda adalah Rp.100000");
                                            System.out.println("8. Jika terdapat masalah pada mesin ATM hubungi 0820-9218-303");
                                            System.out.println("-------------------------------------------------");
                                            System.out.println("\n1.keluar");
                                            System.out.println("2.Kembali");
                                            System.out.print("\nPilih Menu : ");
